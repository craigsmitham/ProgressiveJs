...
{
    public class AjaxForm : JsonNetSerializer
    {
        /// <summary>
        ...
        public AjaxForm AddAdditionalField(string selector)
        {
        ...
        public AjaxForm AddCallBack(string handle, params object[] param)
        {
            Callbacks.Add(
                new Callback
                {
